      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Transform Your Business with Intelligent Solutions, Anytime, Anywhere.`,
              description: `Leverage cutting-edge AI and Web3 technologies to drive innovation and efficiency from any location, at any time`,
            }}
          />
